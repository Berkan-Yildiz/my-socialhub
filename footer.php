        ...
        <div class="row">
            <div class="col-md-6">
                <div class="footer-copyright">
                    <p><span>© <?php echo date('Y'); ?></span> Berkan Yıldız</p>
                </div>
            </div>
            <div class="col-md-6 text-end">
                <ul class="footer-menu">
                    <li><a href="https://github.com/Berkan-Yildiz"><i class="la la-github"></i></a></li>
                    <li><a href="https://www.linkedin.com/in/berkan-y%C4%B1ld%C4%B1z-100691248/"><i class="la la-linkedin"></i></a></li>
                </ul>
            </div>
        </div>
    </div>
